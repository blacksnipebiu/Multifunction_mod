...
namespace Multfunction_mod
{
    ...
    public class Multifunction : BaseUnityPlugin
    {
        ...
        public static int[,] product = new int[50, 3];
        public static int[,] consume = new int[10, 3];
        public float xl_SimpleUI_1_x;
        public float xl_SimpleUI_1_y;
        public float xl_SimpleUI_1_x_move;
        public float xl_SimpleUI_1_y_move;

        public static float buildheight = 1;
        public float tempx1;
        public float tempy1;
        public float buildnotimelasttime;
        ...
        public static float stationtrashtime;
        public static float curStationMinertime;
        public static float lastStationMinertime;
        public float[] warpstationqua;
        public float[] warpsuperstationqua;
        public float[] ChangeValueArray = new float[100];
        public static float[] curTime = new float[10];
        public static float[] lastTime = new float[10];
        ...
        public static bool DriftBuildings=false;
        ...
        public static bool Liangzicomsumestat;
        public static bool stopUniverse;
        public string stackmultiple1 = "";
        public string multipelsmelt1 = "";
        public string watertype = "";
        public static Dictionary<int, Dictionary<int, int>> consumeLiangzi = new Dictionary<int, Dictionary<int, int>>();
        ...
        public static ConfigEntry<string> navplanet;
        public static ConfigEntry<string> watertypePlanet;
        public static ConfigEntry<string> namePlanet;
        public static ConfigEntry<string> nameStar;
        ...
        public static ConfigEntry<Boolean> stationmineropen;
        ...
        public static ConfigEntry<Boolean> stationtrashopen;
        ...
        public static Dictionary<int, Dictionary<int, int>> Beltsignalnumberinput = new Dictionary<int, Dictionary<int, int>>();
        public static Dictionary<int, Dictionary<int, int>> Beltsignalnumberoutput = new Dictionary<int, Dictionary<int, int>>();
        public static Dictionary<int, List<int>> stationslots = new Dictionary<int, List<int>>();
        ...
        public static Dictionary<int, string> namePlanetArray = new Dictionary<int, string>();
        public static Dictionary<int, string> OrnamePlanetArray = new Dictionary<int, string>();
        public static Dictionary<int, string> nameStarArray = new Dictionary<int, string>();
        public static Dictionary<int, string> OrnameStarArray = new Dictionary<int, string>();
        public static List<int> navplanetlist = new List<int>();
        ...
        private GameObject MultiFunctionPanel;
        ...
        void Start()
        {
            ...
            namePlanet = Config.Bind("星球名称", "namePlanet", "");
            nameStar = Config.Bind("恒星名称", "nameStar", "");
            ...
            stationmineropen = Config.Bind("星球矿机", "stationmineropen", false);
            stationtrashopen = Config.Bind("星球垃圾箱", "stationtrashopen", false);
            ...
            ShowCounter1 = Config.Bind("打开窗口快捷键", "Key", new BepInEx.Configuration.KeyboardShortcut(KeyCode.Alpha1, KeyCode.LeftAlt));
            ...
            //初始化星球名字
            foreach (string k in namePlanet.Value.Split(';'))
            {
                if (k.Length == 0) break;
                string[] t = k.Split(',');
                namePlanetArray.Add(int.Parse(t[0]), t[1]);
            }
            //初始化恒星名字
            foreach (string k in nameStar.Value.Split(';'))
            {
                if (k.Length == 0) break;
                string[] t = k.Split(',');
                nameStarArray.Add(int.Parse(t[0]), t[1]);
            }
            lastStationMinertime = Time.time;
        ...
        void Update()
        {
            ...
            if(GameMain.mainPlayer != null && GameMain.mainPlayer.controller != null && GameMain.mainPlayer.controller.cmd.type==ECommand.Build && GameMain.mainPlayer.controller.actionBuild != null)
            {
                if(blueprintPasteToolActive != GameMain.mainPlayer.controller.actionBuild.blueprintPasteTool.active)
                {
                ...
                if (Input.GetKeyDown(KeyCode.UpArrow))
                {
                    ...
                    {
                        GameMain.mainPlayer.controller.actionBuild.blueprintPasteTool.cursorValid = true;
                        GameMain.mainPlayer.controller.actionBuild.blueprintPasteTool.DeterminePreviewsPrestage();
                    }
                }
            ...
            if (Quantumtransport_bool.Value && startsuperstationtime+1<Time.time)
            {
                startsuperstationtime = Time.time;
        ...
        public void OnGUI()
        {
            ...
            if (DisplayingWindow)
            {
                ...
                rt.localPosition = new Vector2(-Screen.width / 2 + xl_SimpleUI_1_x, Screen.height / 2 - xl_SimpleUI_1_y - xl_SimpleUI_1_height.Value);
                Rect windowRect1 = new Rect(xl_SimpleUI_1_x, xl_SimpleUI_1_y, xl_SimpleUI_1_width.Value, xl_SimpleUI_1_height.Value);
                if (leftscaling || rightscaling || topscaling || bottomscaling) { }
                else
                {
                    moveWindow_xl_first(ref xl_SimpleUI_1_x, ref xl_SimpleUI_1_y, ref xl_SimpleUI_1_x_move, ref xl_SimpleUI_1_y_move, ref Window_moving, ref tempx1, ref tempy1, xl_SimpleUI_1_width.Value);
                }
                GUI.DrawTexture(new Rect(xl_SimpleUI_1_x, xl_SimpleUI_1_y, xl_SimpleUI_1_width.Value, xl_SimpleUI_1_height.Value), mytexture);
                scaling_window(xl_SimpleUI_1_width.Value, xl_SimpleUI_1_height.Value, ref xl_SimpleUI_1_x, ref xl_SimpleUI_1_y);
                windowRect1 = GUI.Window(20210218, windowRect1, DoMyWindow1, "OP面板".getTranslate() + "(" + VERSION + ")" + "ps:ctrl+↑↓");
                xl_SimpleUI_1_x_config.Value = xl_SimpleUI_1_x;
                xl_SimpleUI_1_y_config.Value = xl_SimpleUI_1_y;
                if (xl_SimpleUI_1_x < 0 || xl_SimpleUI_1_x > maxwidth)
                {
                    xl_SimpleUI_1_x_config.Value = 100;
                }
                if (xl_SimpleUI_1_y < 0 || xl_SimpleUI_1_y > maxheight)
                {
            ...
            if (ItemDisplayingWindow)
            {
                ...
                windowRect2 = GUI.Window(20210219, windowRect2, DoMyWindow2, "");
            }
        }
        ...
        public int[] doitemfromStarsuper(int itemid, int itemcount,int inc=0,bool take=true)
        {
            ...
            if (energycost != 0)
            {
                ...
                else if (sc.warperCount > 0 && warpsuperstationqua[index] + 5 < Time.time)
                {
                    ...
                    energycost = Quantumenergy.Value / 100;
                    if (!consumeLiangzi.ContainsKey(sc.planetId))
                        consumeLiangzi.Add(sc.planetId, new Dictionary<int, int>());
                    if (!consumeLiangzi[sc.planetId].ContainsKey(1210))
                        consumeLiangzi[sc.planetId].Add(1210, 1);
                    else
                        consumeLiangzi[sc.planetId][1210]++;
                }
            }
            ...
            if (sc.storage[4].itemId > 0 && sc.storage[4].count > 0)
            {
                ...
                if (ip.HeatValue > 0 && sc.energyMax > sc.energy)
                {
                    ...
                    if (!consumeLiangzi.ContainsKey(sc.planetId))
                        consumeLiangzi.Add(sc.planetId, new Dictionary<int, int>());
                    if (!consumeLiangzi[sc.planetId].ContainsKey(ip.ID))
                        consumeLiangzi[sc.planetId].Add(ip.ID, num);
                    else
                        consumeLiangzi[sc.planetId][ip.ID] += num;
                }
            }
        ...
        {
            if (stationmineropen.Value)
            {
                curStationMinertime = Time.time;
        ...
        public void AfterGameStart()
        {
            ...
            {
                StationComponentSet();
                PlayerDataInit(GameMain.history);
                if (Infinitething.Value) { Infiniteall(); }
                if(Mechalogistics_bool.Value&& Time.time- mechalogisticstime > 1)
                {
                    mechalogisticstime = Time.time;
                    mechalogisticsMethod();
                }
                LockPlayerPackage();
                if (blueprintpastenoneed_bool.Value) { BluePrintpasteNoneed(); }
                if (Infiniteplayerpower.Value) { Infinite_player_power(); }
                if (player != null)
                {
                    controlVein();
                    playwithtrashset();
                    ...
                    if (BuildNotime_bool.Value && player.controller.actionBuild.clickTool.factory != null)
                    {
                        ...
                        PlanetFactory pf = planet.factory;
                        if (!buildnotimecolddown && GameMain.mainPlayer.controller.actionBuild.clickTool.factory.prebuildCount>0)
                        {
                            foreach (PrebuildData pd in GameMain.mainPlayer.controller.actionBuild.clickTool.factory.prebuildPool)
                            {
        ...
        public void FirstStartGame()
        {
            if (GameMain.instance != null)
            {
                ...
                if (GameMain.instance.running && !FinallyInit)
                {
                    ...
                    OrnamePlanetArray = new Dictionary<int, string>();
                    OrnameStarArray = new Dictionary<int, string>();
                    ...
                    foreach (StarData sd in GameMain.galaxy.stars)
                    {
                        foreach (PlanetData pd in sd.planets)
                        {
                            ...
                            foreach (VeinData vd in pd.factory.veinPool)
                            {
                                if (vd.id > 0)
                                {
                                    sum[veinindex(vd.productId)] += vd.amount;
                                }
                            }
                    ...
                    foreach (KeyValuePair<int, string> wap in namePlanetArray)
                    {
                        PlanetData pd = GameMain.galaxy.PlanetById(wap.Key);
                        if (pd == null) continue;
                        if (!OrnamePlanetArray.ContainsKey(wap.Key))
                            OrnamePlanetArray.Add(wap.Key, pd.name);
                        pd.name = wap.Value;
                    }
                    foreach (KeyValuePair<int, string> wap in nameStarArray)
                    {
                        StarData sd = GameMain.galaxy.StarById(wap.Key);
                        if (sd == null) continue;
                        if (!OrnameStarArray.ContainsKey(wap.Key))
                            OrnameStarArray.Add(wap.Key, sd.name);
                        sd.name = wap.Value;
                    }
                    FinallyInit = true;
        ...
        public void QuickKeyOpenWindow()
        {
            ...
            if (GameMain.mainPlayer!=null && GameMain.mainPlayer.controller!=null && !GameMain.mainPlayer.controller.actionBuild.active)
            {
        ...
        public void DoMyWindow2(int windId)
        {
            ...
            for (int i = 0; i < itemProtos.Count; i++)
            {
                ...
                if (GUI.Button(new Rect(i % 10 * size, height * size, size, size), itemProtos[i].iconSprite.texture))
                {
                    ...
                    {
                        GameMain.mainPlayer.TryAddItemToPackage(itemProtos[i].ID, StorageComponent.itemStackCount[itemProtos[i].ID], 0, true);
                    }
                    else
                    {
                        GameMain.mainPlayer.TryAddItemToPackage(itemProtos[i].ID, 1, 0, true);
                    }
                }
            }
        ...
        public void OtherPannel()
        {
            ...
            GUILayout.BeginArea(new Rect(10, 10, 10+ (english ? heightdis * 12 : heightdis * 10), heightdis * 17));
            {
                ...
                GUI.Label(returnchangerect(t,heightdis*lines++,2), "以下设置需要进入存档".getTranslate(), style); 
                playwithtrash       = GUI.Toggle(returnchangerect(t, heightdis * lines++, 2), playwithtrash, "丢垃圾(整活用)".getTranslate());
                sunlight_bool.Value = GUI.Toggle(returnchangerect(t, heightdis * lines++, 2), sunlight_bool.Value, "夜灯".getTranslate());
                if(SandBoxMode != GUI.Toggle(returnchangerect(t, heightdis * lines++, 2), SandBoxMode, "创造模式".getTranslate()))
                {
                    SandBoxMode = !SandBoxMode;
                    GameMain.sandboxToolsEnabled = SandBoxMode;
                }
                pasteanyway         = GUI.Toggle(returnchangerect(t, heightdis * lines++, 2), pasteanyway, "蓝图强制粘贴".getTranslate());
                pastebuildanyway    = GUI.Toggle(returnchangerect(t, heightdis * lines++, 2), pastebuildanyway, "建筑铺设无需条件".getTranslate());
                if(closeallcollider != GUI.Toggle(returnchangerect(t, heightdis * lines++, 2), closeallcollider, "关闭所有碰撞体".getTranslate()))
                {
                ...
                stackmultiple1 = Regex.Replace(GUI.TextField(returnchangerect(t, heightdis * lines++, 2), stackmultiple1, 10), @"[^0-9]", "");
                if (GUI.Button(returnchangerect(t, heightdis * lines++, 2), "设置堆叠倍率".getTranslate()))
                {
                ...
                if (GUI.Button(returnchangerect(t, heightdis * lines++, 2), "成就重新检测".getTranslate()))
                {
                    GameMain.data.abnormalData.runtimeDatas = new AbnormalityRuntimeData[3000];
                }
                GUI.Label(returnchangerect(t, heightdis * lines++, 2), "以下设置需要重启游戏".getTranslate(), style);
                multipelsmelt1 = Regex.Replace(GUI.TextField(returnchangerect(t, heightdis * lines++, 2), multipelsmelt1, 10), @"[^0-9]", "");
                if (GUI.Button(returnchangerect(t, heightdis * lines++, 2), "设置冶炼倍数".getTranslate())) MULTIPELSMELT.Value = int.Parse(multipelsmelt1);
                allhandcraft.Value  = GUI.Toggle(returnchangerect(t, heightdis * lines++, 2), allhandcraft.Value, "全部手搓".getTranslate());
                quickproduce.Value  = GUI.Toggle(returnchangerect(t, heightdis * lines++, 2), quickproduce.Value, "快速生产".getTranslate());
            }
            GUILayout.EndArea();
        ...
        public void PlanetPannel()
        {
            ...
            for (int i = 0; i < tempstr.Length; i++)
            {
                ...
                switch (i)
                {
                    ...
                    case 8: tempvalue = stationtrashopen.Value; break;
                    case 9: tempvalue = noneedtrashsand.Value; break;
                    case 10: tempvalue = stationmineropen.Value; break;
                ...
                switch (i)
                {
                    ...
                    case 8: stationtrashopen.Value = tempvalue; break;
                    case 9: noneedtrashsand.Value = tempvalue; break;
                    case 10: stationmineropen.Value = tempvalue; break;
            ...
            if (GUI.Button(new Rect(english ? heightdis * 9 : heightdis * 5, heightdis, heightdis * 4, heightdis), LDB.ItemName(int.Parse(VeintypechineseTranslate(veintype, 1).Trim()))))
            {
            ...
            if (dropdownbutton)
            {
                for (int i = 1; i <= 14; i++)
                {
                    if (GUI.Button(new Rect(english ? heightdis * 9 : heightdis * 5, heightdis * (i+1), heightdis*4, heightdis), LDB.ItemName(int.Parse(VeintypechineseTranslate(i, 1).Trim()))))
                    {
                        dropdownbutton = !dropdownbutton;
                        veintype = i;
                    }
        ...
        public void mechalogisticsMethod()
        {
            ...
            for (int i = 0; i < mechalogistics.Length; i++)
            {
                ...
                if (mechalogistics[i] == 1)
                {
                    ...
                    GameMain.mainPlayer.TryAddItemToPackage(itemid, count, inc, false);
                }
                else
                {
        ...
        Rect returnchangerect(Rect t,int changevalue,int index)
        {
            if (index <= 0 || index > 4) return t;
            switch (index)
            {
                case 1: t.x += changevalue;break;
                case 2: t.y += changevalue; break;
                case 3: t.width += changevalue; break;
                case 4: t.height += changevalue; break;
            }
            return t;
        }
        ...
        public void PlayerDataInit(GameHistoryData historyData)
        {
            if (GameMain.mainPlayer != null && ((player == null || player != GameMain.mainPlayer) || refreshPlayerData))
            {
        ...
        {
            if (GameMain.localPlanet == null || GameMain.localPlanet.factory == null) return;
        ...
        public void SetStationminerCapacity(int newCapacity)
        {
            float[] curtime = curTime;
            float[] lasttime = lastTime;
            int[,] tempproduct = product;
            int[,] tempconsume = consume;
            int len = curTime.Length;
            curTime = new float[newCapacity];
            lastTime = new float[newCapacity];
            product = new int[newCapacity * 5, 3];
            consume = new int[newCapacity, 3];
            Array.Copy(curtime, curTime, len);
            Array.Copy(lasttime, lastTime, len);
            Array.Copy(tempproduct, product, len * 5);
            Array.Copy(tempconsume, consume, len);
        }
        ...
        public void StationComponentSet()
        {
            ...
            foreach (StationComponent sc in GameMain.data.galacticTransport.stationPool)
            {
                ...
                {
                    if (Station_infiniteWarp_bool.Value)
                        sc.warperCount = 50;
                    for (int i = 0; i < sc.storage.Length && (StationStoExtra.Value >= 0 || StationfullCount); i++)
                    {
                        if (sc.isStellar)
                        {
                    ...
                    if (sc.isStellar && sc.name != null)
                    {
                        ...
                        if(stationmineropen.Value && (sc.name.Equals("Station_miner") || sc.name.Equals("星球矿机")))
                        {
                            int pdId = sc.planetId;
                            if (curTime[k] - lastTime[k] > 1)
                            {
                                lastTime[k] = curTime[k];
                                for (int i = 0; i < 5 && sc.energy > 0; i++)
                                {
                                    int itemId = sc.storage[i].itemId;
                                    if (itemId > 0 && sc.storage[i].count <= sc.storage[i].max)
                                    {
                                        int pointminenum = getVeinnumber(itemId, pdId) * Stationminenumber.Value;
                                        if (getVeinnumber(itemId, pdId) > 0 && pointminenum == 0) pointminenum = 1;
                                        else if (getVeinnumber(itemId, pdId) == 0 && itemId != GameMain.galaxy.PlanetById(sc.planetId).waterItemId) continue;

                                        if (sc.energy - pointminenum * GameMain.history.miningSpeedScale * 5000 > 0)
                                        {
                                            int minenum = StationMine(itemId, pointminenum, pdId);
                                            product[k * 5 + i, 0] = itemId;
                                            product[k * 5 + i, 1] = minenum;
                                            product[k * 5 + i, 2] = pdId;
                            ...
                            if (sc.storage[4].itemId > 0 && sc.storage[4].count > 0 && LDB.items.Select(sc.storage[4].itemId).HeatValue > 0
                                && sc.energyMax > sc.energy + LDB.items.Select(sc.storage[4].itemId).HeatValue)
                            {
                                sc.energy += LDB.items.Select(sc.storage[4].itemId).HeatValue;
                                sc.storage[4].count--;
                                consume[k, 0] = sc.storage[4].itemId;
                                consume[k, 1]++;
                                consume[k, 2] = pdId;
                            }
                            k++;
                            if (k + 1 == curTime.Length)
                                SetStationminerCapacity(k + 101);
                        }
                        productmaxindex = k;
                        
                        if (stationtrashopen.Value && (sc.name.Equals("垃圾站")||sc.name.Equals("Station_trash")))
                        {
                            for (int i = 0; i < 5 && sc.energy > 0; i++)
                            {
                                if (sc.storage[i].itemId > 0)
                                {
                                    ...
                                    if (sc.energy - trashnum * 10000 > 0)
                                    {
                                        if (!consumeLiangzi.ContainsKey(sc.planetId))
                                            consumeLiangzi.Add(sc.planetId, new Dictionary<int, int>());
                                        if (!consumeLiangzi[sc.planetId].ContainsKey(sc.storage[i].itemId))
                                            consumeLiangzi[sc.planetId].Add(sc.storage[i].itemId, trashnum);
                                        else
                                            consumeLiangzi[sc.planetId][sc.storage[i].itemId] += trashnum;
        ...
        public string getPlayerData()
        {
            ...
            result += "核心能量上限" + ":" + TGMKinttostring(mecha.coreEnergyCap, "J") + "\n" +
                "核心等级" + ":" + mecha.coreLevel + "\n" +
                "核心功率" + ":" + TGMKinttostring(mecha.reactorPowerGen, "W") + "\n" +
                "采矿速度" + ":" + mecha.miningSpeed + "\n" +
                "制造速度" + ":" + mecha.replicateSpeed + "\n" +
                "研发速度" + ":" + GameMain.history.techSpeed + "\n" +
                "走路速度" + ":" + mecha.walkSpeed + "m/s\n" +
                "跳跃速度" + ":" + mecha.jumpSpeed + "m/s\n" +
                "最大航行速度" + ":" + mecha.maxSailSpeed + "km/s\n" +
                "最大曲速" + ":" + mecha.maxWarpSpeed + "km/s\n" +
                "建造区域" + ":" + mecha.buildArea + "\n" +
                "小飞机速度" + ":" + mecha.droneSpeed + "m/s\n" +
                "小飞机数量 " + ":" + mecha.droneCount + "\n" +
                "小飞机任务节点 " + ":" + mecha.droneMovement + "\n" +
                "小飞机发射能量" + ":" + TGMKinttostring(mecha.droneEjectEnergy, "J") + "\n" +
                "小飞机每米消耗能量" + ":" + TGMKinttostring(mecha.droneEnergyPerMeter, "J") + "\n" +
                "背包数量 " + ":" + player.package.size + "\n" +
                "";
        ...
        //获取pdid星球itemid矿脉数量
        public int getVeinnumber(int itemid, int pdid)
        {
            int number = 0;
        ...
        {
            if (GameMain.mainPlayer != null && Input.GetMouseButton(0))
            {
            ...
            if (Input.GetMouseButton(0)&&!GameMain.mainPlayer.controller.actionBuild.dismantleTool.active)
            {
                ...
                if (pointveindata.amount != 0)
                {
                    ...
                    {
                        RaycastHit raycastHit1;
                        if (GameMain.mainPlayer == null || !Physics.Raycast(GameMain.mainPlayer.controller.mainCamera.ScreenPointToRay(Input.mousePosition), out raycastHit1, 800f, 8720, (QueryTriggerInteraction)2))
                            return;
                        Vector3 raycastpos = raycastHit1.point;
        ...
        public void buryallvein()
        {
            ...
            foreach (VeinData i in pd.factory.veinPool)
            {
                GameMain.gpuiManager.AlterModel((int)i.modelIndex, i.modelId, i.id, i.pos, false);
            }
        ...
        public void BreakFromGroup(PlanetData planet, int VeinId)
        {
            VeinData[] veinPool = planet.factory.veinPool;
            int orginGroup = veinPool[VeinId].groupIndex;
            veinPool[VeinId].groupIndex = (short)planet.factory.AddVeinGroup(veinPool[VeinId].type, veinPool[VeinId].pos.normalized);
            planet.factory.RecalculateVeinGroup(veinPool[VeinId].groupIndex);
            planet.factory.RecalculateVeinGroup(orginGroup);
            planet.factory.ArrangeVeinGroups();
        }
        public void SelectNewGroup(PlanetData planet, int VeinId,int pointgroupindex)
        {
            VeinData[] veinPool = planet.factory.veinPool;
            short groupIndex = veinPool[VeinId].groupIndex;
            for (int index = 0; index < planet.factory.veinGroups.Length; ++index)
            {
                int num;
                if (index != groupIndex && veinPool[VeinId].type == planet.factory.veinGroups[index].type)
                {
                    Vector3 vector3 = veinPool[VeinId].pos - planet.factory.veinGroups[index].pos * (planet.realRadius + 2.5f);
                    num = vector3.magnitude <= 10.0 ? 1 : 0;
                }
                else
                    num = 0;
                if (num != 0 || pointgroupindex!=-1)
                {
                    veinPool[VeinId].groupIndex = (short)(pointgroupindex != -1 ? pointgroupindex : index);
                    return;
                }
            }

            planet.factory.RecalculateVeinGroup(veinPool[VeinId].groupIndex);
            planet.factory.RecalculateVeinGroup(groupIndex);
            planet.factory.ArrangeVeinGroups();
            planet.factory.AssignGroupIndexForNewVein(ref veinPool[VeinId]);
        }
       ...
       public void FinishDysonShell()
        ...
        public void removeallbuild(int temp)
        {
            if (GameMain.localPlanet != null && GameMain.localPlanet.factory!=null)
            {
                ...
                if (temp == 1) entityitemnoneed = true;
                foreach (EntityData etd in GameMain.localPlanet.factory.entityPool)
                {
                    ...
                    if (stationId > 0)
                    {
                        ...
                        for (int i = 0; i < sc.storage.Length && temp == 0; i++)
                        {
        ...
        public int StationMine(int itemid, int minenumber, int pdid)
        {
            ...
            if (itemidtoVeintype(itemid) == EVeinType.None || pd == null)
            {
                return 0;
            }
            ...
            foreach (VeinData i in pd.factory.veinPool)
            {
                if ( i.type == itemidtoVeintype(itemid))
                {
        ...
        public void Addpackagesize()
        {
            if (player != null)
            {
                GameMain.mainPlayer.package.SetSize(GameMain.mainPlayer.package.size + UIRoot.instance.uiGame.inventory.colCount);
            }
        }
        ...
        public void lockTech()
        {
            ...
            for (int index = 0; index < dataArray.Length; index++)
            {
                ...
                {
                    global::TechState techState = GameMain.history.techStates[tp.ID];
                    techState.unlocked = false;
                    techState.curLevel = tp.Level;
                    techState.hashUploaded = 0L;
                    techState.hashNeeded = LDB.techs.Select(tp.ID).GetHashNeeded(techState.curLevel);
        ...
        public void Infinite_player_power()
        {
        ...
        public void play_with_trash()
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                {
                    GameMain.mainPlayer.ThrowTrash(grids[grids.Length - 1 - i].itemId, 1, 0, 0);
                }
                else
                {
                    break;
        ...
        public int getstringenglishwordlen(string str)
        {
            int sum = 0;
        ...
        public int veinindex(int itemid)
        {
            switch (itemid)
            {
                case 1001: return 1;
        ...
        public EVeinType itemidtoVeintype(int itemid)
        {
            switch (itemid)
            {
